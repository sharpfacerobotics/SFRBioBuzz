...
public final class MecanumDrive {
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // TODO: make sure your config has motors with these names (or change
        //  them)
        ...
        // TODO: make sure your config has an IMU with this name (can be BNO
        //  or BHI)
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
    ...
    public void setDrivePowers(PoseVelocity2d powers) {
        MecanumKinematics.WheelVelocities<Time> wheelVels =
                new MecanumKinematics(1).inverse(
    ...
    public class DriveLocalizer implements Localizer {
        ...
        private int lastLeftFrontPos, lastLeftBackPos, lastRightBackPos,
                lastRightFrontPos;
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront =
                    new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftFront));
            leftBack =
                    new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftBack));
            rightBack =
                    new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightBack));
            rightFront =
                    new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightFront));
        ...
        public PoseVelocity2d update() {
            ...
            Twist2dDual<Time> twist =
                    kinematics.forward(new MecanumKinematics.WheelIncrements<>(
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            mecanumCommandWriter.write(new MecanumCommandMessage(
                    voltage, leftFrontPower, leftBackPower, rightBackPower,
                    rightFrontPower
            ));
            ...
            // only draw when active; only one drive action should be active
            // at a time
    ...
    public final class TurnAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            c.fillCircle(turn.beginPose.position.x, turn.beginPose.position.y
                    , 2);
